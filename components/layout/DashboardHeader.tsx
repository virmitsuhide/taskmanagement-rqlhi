...
export function DashboardHeader({ displayName, role, title, showBack }: Props) {
  return (
    <header className="sticky top-0 z-40 flex h-14 items-center gap-3 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/70 px-4 md:px-6 print:hidden">
      {showBack && (
