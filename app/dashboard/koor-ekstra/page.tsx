...
export default async function KoorEkstraDashboardPage() {
  ...
  return (
    <div>
      <DashboardHeader displayName={session.displayName} role={session.role} title="Dashboard Koor Ekstra" showBack />
      <div className="p-4 md:p-6 space-y-6 max-w-4xl">
        ...
        <section>
          <h2 className="text-sm font-semibold mb-3">Rapat Kumik Terbaru</h2>
